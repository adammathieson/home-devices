...
const tl = gsap.timeline()
    tl.fromTo("#scene-4", 1, {opacity: 0}, {opacity: 1})
    tl.to("#arm-int-right", 0.15, {y:-5, repeat: 2})
    tl.to("#window-job-app", 0, {display: "none"})
    tl.to("#guy4", 0, {scaleX: -1, transformOrigin: "75% 50%"})
    ...
    tl.to("#guy4, #chair-front", 3, {x: -800}, "-=.15")
    tl.fromTo("#scene-4", 1, {opacity: 1}, {opacity: 0, onComplete: goToScene5}, "-=2" )